...
[**Download Practice Activity v0.4.0 for macOS (.dmg) →**](https://github.com/travishuff/practice-activity-dashboard/releases/download/v0.4.0/Practice-Activity-v0.4.0-macOS-universal.dmg)
