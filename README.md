...
> [!NOTE]
> The release artifact is a universal `.dmg` that works on Apple Silicon and
> Intel Macs. This development build is unsigned, so macOS may ask you to
> approve it the first time it is opened.
>
